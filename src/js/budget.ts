...
export function calculateQuotaForDate(targetDate: Date): { base: number; quota: number; carryover: number } {
    ...
    const todaysPurchases = groupedPurchases!.get(targetDStr) || [];
    ...
    const todaysIncomes = groupedIncomes!.get(targetDStr) || [];
